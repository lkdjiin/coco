...
describe CoverageResult do
  ...
  it "must refuse negative threeshold" do
    lambda {CoverageResult.new(-1, RAW_RESULT)}.should raise_error(ArgumentError)
  end
  
  it "must accept threeshold above 100%" do
    lambda {CoverageResult.new(101, RAW_RESULT)}.should_not raise_error
  end
  
  it "must exclude external sources" do
    result = CoverageResult.new(90, RAW_RESULT)
  ...
  it "must exclude sources above threeshold" do
    result = CoverageResult.new(90, RAW_RESULT_2)
